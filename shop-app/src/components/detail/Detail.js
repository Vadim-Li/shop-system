    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        >
          ...
          >
            <Text style={{ fontWeight: "bold" }}>分期</Text>
            <Text style={{ marginLeft: 30 }}>低至{itemData.shopPrice}×0期</Text>
            <AntDesign
              name="right"
        ...
        >
          ...
          >
            ...
            <View>
              <Text style={{ marginLeft: 30 }}>武汉市 洪山区</Text>
          ...
          >
            <Text style={{ fontWeight: "bold" }}>服务</Text>
            <Text style={{ marginLeft: 30, color: "grey" }}>
          ...
          <Text style={{ marginLeft: 68, color: "grey" }}>
            <MaterialCommunityIcons name="sticker-check-outline" size={16} />
            7天无理由退货
          </Text>
        </View>
