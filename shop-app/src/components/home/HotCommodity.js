        ...
        {hotCommoditys &&
          hotCommoditys.map((hotCommodity, index) => (
            <Card
              ...
              // imageSource={require(`D:/IdeaProjects/shop-system/shop/src/main/resources/static/img/${hotCommodity.image}`)}
              // imageSource={{
              //   uri: `D:/IdeaProjects/shop-system/shop/src/main/resources/static/img/${hotCommodity.image}`,
              // }}
