...
public class WxPayServiceImpl implements WxPayService {
    ...
    @Override
    public Map<String, Object> nativePay(Long productId,Long uId) throws Exception {

        log.info("生成订单");

        //生成订单
        OrderInfo orderInfo = orderInfoService.createOrderByProductId(productId,uId, PayType.WXPAY.getType());
    ...
    @Override
    public Map<String, Object> nativePayV2(Long productId, String remoteAddr,Long uId) throws Exception {
