...
public class WxPayV2Controller {
    ...
    public R createNative(@PathVariable Long productId, HttpServletRequest request,Long uId) throws Exception {

        log.info("发起支付请求 v2");

        String remoteAddr = request.getRemoteAddr();
        Map<String, Object> map = wxPayService.nativePayV2(productId, remoteAddr,uId);
