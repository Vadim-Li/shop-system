...
public class WxPayController {
    ...
    @PostMapping("/native/{productId}/{uId}")
    public R nativePay(@PathVariable Long productId,@PathVariable Long uId) throws Exception {

        log.info("发起支付请求 v3");

        //返回支付二维码连接和订单号
        Map<String, Object> map = wxPayService.nativePay(productId,uId);
